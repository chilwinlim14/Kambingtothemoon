...
// {
	if(strpos($_SERVER['HTTP_REFERER'], 'berita') !== false){
		$_SESSION['RF']["subfolder"] = 'berita';
	} else if(strpos($_SERVER['HTTP_REFERER'], 'koleksi_kategori') !== false){
		$_SESSION['RF']["subfolder"] = 'koleksikat';
	} else if(strpos($_SERVER['HTTP_REFERER'], 'koleksi') !== false){
		$_SESSION['RF']["subfolder"] = 'koleksi';
	} else if(strpos($_SERVER['HTTP_REFERER'], 'halaman') !== false){
		$_SESSION['RF']["subfolder"] = 'halaman';
	}  else if(strpos($_SERVER['HTTP_REFERER'], 'tentang') !== false){
		$_SESSION['RF']["subfolder"] = 'halaman'; // jadikan satu dengan halaman
	}  else if(strpos($_SERVER['HTTP_REFERER'], 'pengaturan') !== false){
		$_SESSION['RF']["subfolder"] = 'pengaturan';
	}  else if(strpos($_SERVER['HTTP_REFERER'], 'agenda') !== false){
		$_SESSION['RF']["subfolder"] = 'agenda';
	}
	// else {
