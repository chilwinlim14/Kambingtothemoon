<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $("#data_jurnal_ternak").DataTable({
            ...
            serverSide: true,
            ajax: {
                url: base_url + "jurnal_ternak/data/",
                type: "POST"
            },
            columns: [{
                    data: "id_jurnal",
                ...
                
                {
                    ...
                    render: function(data, type, row, meta) {
                            ...
                            return `<div class="text-center">
                                <a class="btn btn-sm btn-warning" href="${base_url}jurnal_ternak/edit/${data}">
    ...
    function hapus(id) {
        Swal({
            ...
            if (result.value) {
                $.getJSON(base_url + "data_jurnal_ternak/delete/" + id, function(data) {
                    Swal({
