...
class Users extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('users/data-js', true);
	}
	...
	public function add()
	{
		...
		$this->load->view('_template/dashboard/_header.php', $data);
		$this->load->view('users/add');
		$this->load->view('_template/dashboard/_footer.php');
	}
	...
	public function save()
	{
		...
		if ($this->form_validation->run() === FALSE) {
			...
			if ($this->ion_auth->register($this->input->post('identity'), $this->input->post('password'), $this->input->post('email'), $additional_data, $groups)) {
